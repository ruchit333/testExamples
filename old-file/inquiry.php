...
<title>NewGPI - Contact Page</title>
...
<div id="templatemo_main">
    ...
    <h2>Inquiry Form</h2>
        ...
        <h4>Send us a message now!</h4>
            <p>&nbsp;</p>
            <div id="contact_form">
               <form method="post" name="inquiry" action="mail.php">
						...
						<label for="subject">Subject:</label> <input type="text" name="client_subject" id="client_subject" class="input_field" />
...
<div id="templatemo_footer_wrapper">
    <div id="templatemo_footer">
		<a href="http://tw.forwallpaper.com/search/tagged.html" title="?? wallpaper" class="footer_img_link"  ><img src="images/link.jpg" alt="?? wallpaper" title="?? wallpaper" /></a>
