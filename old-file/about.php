...
<div id="templatemo_main">
    ...
    <div id="content">
    	<h2>Our History</h2>
        <p>We&nbsp;<strong>&nbsp;“New Gujarat Plastic Industries”</strong>&nbsp;are pioneer manufacturing and supplying a  wide range Virgin Plastic based Daily Utility Products from&nbsp;<strong>Ahmedabad, India</strong>. These products  are appreciated all across for theory excellent features such as 100% virgin  plastic material, resistance efficiency, and durable finish. We manufacture  these products using high grade raw material and advanced engineering  techniques. We strictly follow ethical business standards and transparent  dealings that have helped us to gain the trust and confidence of customers. We  supply in foreign markets as well.<br />
          <br />
Our advanced manufacturing facility that is armed with the necessary machines  enable us to offer our customers with efficient products. We have a team of  experienced professionals who support us in achieving complete customer  satisfaction by offering best range of products. Considering the necessity of  customers we also customize the products.</p>
        <p>Under the able guidance of our mentor<strong>&nbsp;</strong><strong>Mr. Mitesh Parikh</strong>&nbsp;&amp;&nbsp;<strong>Mr. Sameer Parikh</strong>&nbsp;, we have been able to create a niche  in the industry of manufacturing<strong>&nbsp;</strong><strong>container,  house hold product &amp; school items</strong>. His rich industry experience has  guided us to become one of the proficient companies among others. We supply in  Mumbai and foreign markets.</p>
...
<div id="templatemo_footer_wrapper">
    <div id="templatemo_footer">
		<a href="http://it.forwallpaper.com/search/sears.html"  class="footer_img_link"  target="_blank"><img src="images/link.jpg" alt="sears wall paper from it.forwallpaper.com" title="sears wall paper" /></a>
