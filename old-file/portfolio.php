...
<div id="templatemo_main">
			...
			<div class="col one_fourth gallery_box">
               <img src="images/listimage/10.jpg" alt="Image 01" class="image_frame"/>
                <h5>Maecenas Orci Varius</h5>
                <p>Duis feugiat lacus et lacus sodales id semper vel mi congue massa posuere.</p>
				 <span class="more_but"><a href="http://localhost/newgpi/details.php?title=img10" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/2.jpg" alt="Image 02" class="image_frame"/>
                <h5>Tempor Eget leo</h5>
                <p>Morbi porta, sem vitae lacinia convallis ultricies arcu neque eu elit.</p>
				 <span class="more_but"><a href="http://localhost/newgpi/details.php?title=img2" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/3.jpg" alt="Image 03" class="image_frame"/>
			 ...
			 <span class="more_but"><a href="http://localhost/newgpi/details.php?title=img3" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box no_margin_right">
                <img src="images/listimage/4.jpg" alt="Image 04" class="image_frame"/>
                <h5>Donec in Volutpat Erat</h5>
                <p>Aliquam rutrum vehicula turpis. Quisque at sapien odio, id placerat neque. </p>
			 <span class="more_but"><a href="http://localhost/newgpi/details.php?title=img4" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/6.jpg" alt="Image 05" class="image_frame"/>
                <h5>Class Aptent Taciti </h5>
                <p>Fusce fringilla mollis tincidunt. Nullam accumsan bibendum risus facilisis.</p>
				<span class="more_but"><a href="http://localhost/newgpi/details.php?title=img6" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/7.jpg" alt="Image 06" class="image_frame"/>
                <h5>Consectetur Adipiscing</h5>
                <p> Vestibulum quis nulla nunc, nec lobortis nunc sed ac arcu ipsum, ut suscipit neque.</p>
				<span class="more_but"><a href="http://localhost/newgpi/details.php?title=img7" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/8.jpg" alt="Image 07" class="image_frame"/>
                <h5>Donec Purus Nulla</h5>
                <p>Suspendisse tempus hendrerit luctus. Donec fringilla volutpat felis ut bibendum.</p>
				<span class="more_but"><a href="http://localhost/newgpi/details.php?title=img8" class="more">More</a></span>
			</div>
            
            <div class="col one_fourth gallery_box">
                <img src="images/listimage/9.jpg" alt="Image 07" class="image_frame"/>
                <h5>Donec Purus Nulla</h5>
                <p>Suspendisse tempus hendrerit luctus. Donec fringilla volutpat felis ut bibendum.</p>
				<span class="more_but"><a href="http://localhost/newgpi/details.php?title=img9" class="more">More</a></span>
			</div>
...
<div id="templatemo_footer_wrapper">
    <div id="templatemo_footer">
		<a href="http://tw.forwallpaper.com/" title="更多的資訊" class="footer_img_link"  target="_blank"><img src="images/link.jpg" alt="更多的資訊" title="更多的資訊" /></a>
